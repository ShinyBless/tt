...
public class MenuItems {
    ...
    public static ItemStack staffconfigitem2() {
        ItemStack sci2 = new ItemStack(Material.REDSTONE_COMPARATOR);
    ...
    public static ItemStack staffconfigitem3(){
        ItemStack sci3 = new ItemStack(Material.TOTEM);
    ...
    public static ItemStack stafftowersitem2(){
        ItemStack sti2 = new ItemStack(Material.ENCHANTMENT_TABLE);
    ...
    public static ItemStack UnderOffMenu(){
